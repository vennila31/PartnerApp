...
class ActiveOrderViewModel : ViewModel() {
    ...
    private fun populateList() {
        ...
        orderArrayList!!.add(
            OrdersData(
                R.drawable.rrk,"123456789","04.00 PM"
            ,"12, Abcdefgh street, Anna nagar,Chennai -21.","2 Km","Active","Start")
        )
        orderArrayList!!.add(
            OrdersData(
                R.drawable.rrk,"123456789","04.00 PM"
            ,"12, Abcdefgh street, Anna nagar,Chennai -21.","2 Km","Active","Reached Stop")
        )
        orderArrayList!!.add(
            OrdersData(
                R.drawable.rrk,"123456789","04.00 PM"
            ,"12, Abcdefgh street, Anna nagar,Chennai -21.","2 Km","Active","Order Picked")
        )
        orderArrayList!!.add(
            OrdersData(
                R.drawable.rrk,"123456789","04.00 PM"
            ,"12, Abcdefgh street, Anna nagar,Chennai -21.","2 Km","Active","Order delivered")
        )
